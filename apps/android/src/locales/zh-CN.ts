const zhCN = {
  ...
  workspaces: {
    ...
    emptyTitle: '还没有工作区', emptyBody: '选择电脑上的项目目录，将相关对话整理在一起。', search: '搜索工作区', clearSearch: '清除搜索', noSearchResults: '没有找到工作区', noSearchResultsBody: '试试搜索其他名称或目录路径。', options: '管理工作区', addFavorite: (title: string) => `将“${title}”加入收藏夹`, removeFavorite: (title: string) => `将“${title}”移出收藏夹`, favoriteUnavailable: '收藏夹中的这个工作区已不在电脑上，可能已被删除。', noSessions: '还没有对话，点击新建', unnamedSession: '未命名对话', codex: 'CodeX',
