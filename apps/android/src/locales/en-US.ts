...
const enUS = {
  tools: {
    ...
    "tooLarge": "This page exceeds the Host read limit.",
    "failed": "The operation failed. Check the connection and retry.",
    "newTerminal": "New terminal",
    "closeTerminal": "End terminal",
    "closeBody": "This will terminate processes in this terminal.",
    "terminalHint": "Runs as the computer user, independently of Agent approvals.",
